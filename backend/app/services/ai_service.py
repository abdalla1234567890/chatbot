...
**الخطوات:**
1. تحديد المنتج → 2. جمع **كل** المواصفات الأساسية → 3. تفاصيل إضافية + الكمية → 4. سؤال العميل: "هل لديك أي طلبات لمواد أخرى تود إضافتها قبل تحديد الموقع؟" ← إذا "نعم": عد للخطوة 1 للصنف الجديد ← إذا "لا": سؤال الموقع (طباعة `###ASK_LOCATION###`) → 5. **فوراً بعد اختيار الموقع**: إرسال الملخص الكامل لجميع الأصناف + `###DATA_START###`.
